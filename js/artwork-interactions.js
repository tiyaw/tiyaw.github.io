...
class ArtworkInteractionsManager {
  ...
  addTemporaryDescriptions() {
    ...
    const descriptions = [
      ...
      'Offset and screen printing poster design',
      'Genrative art in TouchDesigner',
      'Motion graphics in Cavalry',
      'Creating patterns inspired from Sarkhej Roza architecture',
      'Generative motion graphics in Cavalry',
      'AR experience built with Adobe Aero',
      'My childhood story in everyday modern objects in traditional Ptattachitra artform.',
      'AI-generated graphics using RunwayML',
      'Polygon digital portrait in Illustrator',
      'Isometric devnagri typography using poster color on paper',
      'Mixmedia Illustration combining traditional and digital techniques for children poem books'
    ];
